...
function init () {
    if (url.search('https://quizziz.com/join/game/') || url.search('https://quizziz.com/join/game/') == 0) {
        ...
        refreshCheatButton.onclick = () => init();
